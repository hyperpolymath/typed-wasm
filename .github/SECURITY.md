...
Replace all  values with your information:
  typed-wasm     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  typed-wasm             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/typed-wasm/security/advisories/new)
...
- This repository (`hyperpolymath/typed-wasm`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/typed-wasm/security/advisories)
...
When using typed-wasm, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/typed-wasm/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/typed-wasm/security/advisories/new) or {{SECURITY_EMAIL}} |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/typed-wasm/discussions) |
...
*Thank you for helping keep typed-wasm and its users safe.* 🛡️
