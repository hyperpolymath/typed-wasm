...
// Replace typed-wasm, Typed Wasm — See README.adoc for details., just run, Typed Wasm started successfully. with actuals
= typed-wasm — Quick Start for Users
:toc:
:toclevels: 2

== What is typed-wasm?

Typed Wasm — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./typed-wasm-portable
----
...
[source]
----
Typed Wasm started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/typed-wasm/wiki
