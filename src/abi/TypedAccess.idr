...
public export
getResultType : Get schema name -> {auto membership : FieldIn name schema} -> WasmType
...
public export
accessAddr : Region schema -> (idx : Nat) -> FieldIn name schema -> Nat
accessAddr r idx membership =
